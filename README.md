...
#3 安装打包工具
##3.1 下载
打开[快发大师官网](http://www.haojieru.com),下载快发大师客户端
##3.2 安装
...
#4 注册账号
目前快发大师只接受企业用户注册，具体的注册流程请移步至[开放平台](http://open.haojieru.com/)
...
##5.7 如何打包
在`左边栏`选中`某款游戏`后，点击`母包地址`后的`浏览按钮`，选择已经接入快发大师的母包
...
![](http://static.youxigongchang.com/upload/game/201504/09/14/40/erzXD0.png)
    ...
    像柴米、腾凤、天逸达渠没有用户系统。接入的是快发大师的登录系统，所以在打包之前请联系我们客服，把用户系统数据同步一下，以免出现登录不上的情况。
